...
class ClipboardPage(QWidget):
    ...
    def __init__(self, repository: ClipboardRepository, *, dark: bool) -> None:
        ...
        self.clear_button.setAccessibleDescription("Delete all unpinned clipboard items")
        ...
        empty_title = QLabel("Your clipboard, close at hand")
        empty_title.setObjectName("emptyTitle")
        empty_title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        empty_layout.addWidget(empty_title)
        self.empty = QLabel("Recent copied text will appear here.")
        ...
        self.copy_button.setAccessibleDescription("Copy selected item to clipboard")
        self.copy_button.clicked.connect(self.copy_current)
        actions.addWidget(self.copy_button)
        self.pin_button = QPushButton("Pin")
        self.pin_button.setObjectName("clipboardPin")
        self.pin_button.setAccessibleDescription("Pin or unpin selected item")
        self.pin_button.clicked.connect(self.toggle_pin)
        actions.addWidget(self.pin_button)
        self.delete_button = QPushButton("Delete")
        self.delete_button.setObjectName("clipboardDelete")
        self.delete_button.setAccessibleDescription("Delete selected item from history")
    ...
    def _update_view(self) -> None:
        ...
        self.empty.setText("No matches" if self.query else "Recent copied text will appear here.")
        self.empty_container.setVisible(not has_items)
